            ...
            <div className="w-full md:w-[450px] md:max-w-[450px] bg-white p-5 md:rounded-2xl flex flex-col gap-10 py-10">
                ...
                <div className="flex flex-col gap-5">
                    <div className="flex flex-col gap-2">
                        <h6 className="font-semibold">What did Asha see from the window?</h6>
                        <div className="flex flex-col gap-2">
                            <div>
                                <input type="radio" name="q1" value="a" /> A: The Moon
                            </div>
                            <div>
                                <input type="radio" name="q1" value="b" /> B: The Earth
                            </div>
                            <div>
                                <input type="radio" name="q1" value="c" /> C: Mars
                            </div>
                            <div>
                                <input type="radio" name="q1" value="d" /> D: The Space Station
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <h6 className="font-semibold">What time of day was described?</h6>
                        <div className="flex flex-col gap-2">
                            <div>
                                <input type="radio" name="q2" value="a" /> A: Sunrise
                            </div>
                            <div>
                                <input type="radio" name="q2" value="b" /> B: Noon
                            </div>
                            <div>
                                <input type="radio" name="q2" value="c" /> C: Sunset
                            </div>
                            <div>
                                <input type="radio" name="q2" value="d" /> D: Midnight
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <h6 className="font-semibold">How did Asha feel?</h6>
                        <div className="flex flex-col gap-2">
                            <div>
                                <input type="radio" name="q3" value="a" /> A: Nervous
                            </div>
                            <div>
                                <input type="radio" name="q3" value="b" /> B: Lonely
                            </div>
                            <div>
                                <input type="radio" name="q3" value="c" /> C: Inspired
                            </div>
                            <div>
                                <input type="radio" name="q3" value="d" /> D: Scared
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                ...
                <Link href="/condition3/instructions" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded h-[45px] cursor-pointer flex justify-center items-center">
                    ▶️ Submit
                </Link>
            </div>
        </div>
