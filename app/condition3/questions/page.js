            ...
            <div className="w-full md:w-[450px] md:max-w-[450px] bg-white p-5 md:rounded-2xl flex flex-col gap-10 py-10">
                ...
                <div className="flex flex-col gap-5">
                    <div className="flex flex-col gap-2">
                        <h6 className="font-semibold">What did Leo want to do?</h6>
                        <div className="flex flex-col gap-2">
                            <div>
                                <input type="radio" name="q1" value="a" /> A: Learn how to cook pasta
                            </div>
                            <div>
                                <input type="radio" name="q1" value="b" /> B: Bake a perfect cake
                            </div>
                            <div>
                                <input type="radio" name="q1" value="c" /> C: Open a bakery
                            </div>
                            <div>
                                <input type="radio" name="q1" value="d" /> D: Write a recipe book
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <h6 className="font-semibold">What improved the flavor of the cake?</h6>
                        <div className="flex flex-col gap-2">
                            <div>
                                <input type="radio" name="q2" value="a" /> A: More sugar
                            </div>
                            <div>
                                <input type="radio" name="q2" value="b" /> B: Less flour
                            </div>
                            <div>
                                <input type="radio" name="q2" value="c" /> C: A pinch of salt
                            </div>
                            <div>
                                <input type="radio" name="q2" value="d" /> D: Extra cocoa
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <h6 className="font-semibold">What did Leo tell his friends when asked for the recipe?</h6>
                        <div className="flex flex-col gap-2">
                            <div>
                                <input type="radio" name="q3" value="a" /> A: He would text it later
                            </div>
                            <div>
                                <input type="radio" name="q3" value="b" /> B: He sold it to a bakery
                            </div>
                            <div>
                                <input type="radio" name="q3" value="c" /> C: It was a secret
                            </div>
                            <div>
                                <input type="radio" name="q3" value="d" /> D: He forgot the recipe
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                ...
                <Link href="/condition4/instructions" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded h-[45px] cursor-pointer flex justify-center items-center">
                    ▶️ Submit
                </Link>
            </div>
        </div>
